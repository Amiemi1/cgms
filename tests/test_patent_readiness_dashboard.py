...
def test_isolated_dashboard_route_renders_masked_view() -> None:
    ...
    assert "Production Access Disabled" in body
...
def test_production_application_does_not_register_dashboard() -> None:
    production_paths = {
        route.path
