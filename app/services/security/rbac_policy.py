...
VIEW_PATENT_GOVERNANCE = "view_patent_governance"
VIEW_PATENT_SENSITIVE = "view_patent_sensitive"
...
def has_permission(
    ...
    return normalized_permission in get_permissions(role)
...
def has_all_permissions(
    ...
    assigned_permissions = get_permissions(role)
